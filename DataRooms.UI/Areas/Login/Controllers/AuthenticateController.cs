    ...
    public class AuthenticateController : Controller
    {
        ...
        public async Task<ActionResult> Login(AuthenticateRequest model)
        {
            try
            {
                ...
                if (/*true*/ ModuleAvailable())
                {
                    ...
                    if (response != null)
                    {
                        LogWriter.LogWrite("response found");
            ...
            {
                //var notification = "No Active Modules Available";
                return RedirectToAction("Login", "Authenticate", new { area = "Login", message = ex.Message });
            }
        ...
        public bool ModuleAvailable()
        {
            try
            {
                ...
                LogWriter.LogWrite(license.Column4);
                LogWriter.LogWrite(license.Column5);
                return true;
