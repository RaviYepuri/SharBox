...
namespace DataRooms.UI.Areas.Home
{
    public class HomeAreaRegistration : AreaRegistration 
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context) 
        {
            ...
            context.MapRoute(null, "smtptest/index", new { action = "Index", controller = "SmtpTest", id = UrlParameter.Optional });
            context.MapRoute(null, "smtptest/sendtestemail", new { action = "SendTestEmail", controller = "SmtpTest", id = UrlParameter.Optional });
        }
    }
}