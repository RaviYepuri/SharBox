    ...
    public class SendEmail
    {
        ...
        public string SendTestEmail(string from, string to)
        {
            ...
            try
            {
                ...
                //message.Body = "Test Email from ITManager" + "" + "\n";
                //smtp.Port = 25;
                //smtp.Host = "smtp.gmail.com"; //for gmail host  
                //smtp.EnableSsl = false;
                //smtp.UseDefaultCredentials = true;
                //smtp.Credentials = new NetworkCredential("ysankar74@gmail.com", "DevAish@090210");
                ...
                EmailObject emailObject = new EmailObject()
                {
                    MailBody = "Test Email from SharBox",
                    MailSubject = "Test Email from SharBox"
                };
                var emailConfig = DataCache.EmailConfiguration.First();
                System.Net.Mail.MailMessage msg = new System.Net.Mail.MailMessage(emailConfig.SenderAddress, to);
                ...
                var client = new SmtpClient
                {
                    ...
                    Credentials = new NetworkCredential("satraapps@satragroup.in", "satra123")
                };

                MailMessage mailMessage = new MailMessage("satraapps@satragroup.in", "satraapps@satragroup.in")
                {
                    Body = emailObject.MailBody,
                    Subject = emailObject.MailSubject,
                    IsBodyHtml = true
                };
                client.Send(mailMessage);

                //using (SmtpClient smtp = new SmtpClient(emailConfig.ServerAddress, Convert.ToInt32(emailConfig.PortNumber)))
                //{
                ...
                //SendingEmail(emailObject, mailServer, emailConfig, "Narayana.pappoppula@gmail.com");
            }
            catch (Exception ex)
            {
